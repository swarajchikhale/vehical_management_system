      ...
      <div className="container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem' }}>
        ...
        >
          ...
          <div>
            ...
            <div style={{ fontSize: '0.7rem', color: 'var(--accent-emerald)', fontWeight: 600, cursor: 'help' }} title="All dispatch services & vehicle fleet APIs operational">● System Active • Vehicle OS • Fleet Ready</div>
          </div>
        </div>
